# F2 - An open framework for the financial services industry.

The project repository for F2 documentation. For more information go to [OpenF2.org](http://www.openf2.org) or [to the docs](http://docs.openf2.org).
