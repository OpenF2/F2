F2.Apps["com_openf2_examples_csharp_stocktwits"] = (function () {
    ...
    App_Class.prototype.getTwits = function () {
        $.ajax({
            ...
            url: "https://api.stocktwits.com/api/2/streams/symbol/" + this.symbol + ".json",
            data: { },
            cache: true,
            context: this
    ...
    App_Class.prototype.replaceDollarSigns = function (text) {
        ...
        return text.replace(exp, "<a href='javascript:;' data-symbol='$1' class='focus' title='Change context to $$$1'>$$$1</a>");
    }
