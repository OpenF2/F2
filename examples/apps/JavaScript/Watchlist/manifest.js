/* global F2_jsonpCallback_com_openf2_examples_javascript_watchlist */

F2_jsonpCallback_com_openf2_examples_javascript_watchlist({
  'scripts': [
    '../apps/JavaScript/Watchlist/vendor/jquery.cookie.js',
    '../apps/JavaScript/Watchlist/vendor/moment.1.7.0.min.js',
    '../apps/JavaScript/Watchlist/scripts/format.js',
    '../apps/JavaScript/Watchlist/scripts/appclass.js'
  ],
  'styles': [
    '../apps/JavaScript/Watchlist/styles/watchlist.css'
  ],
  'apps': [{
    'html': [
      '<div>',
