describe('F2.AppHandlers', function() {
  ...
  it('should use AppHandlers if container config handlers are defined', function() {
    ...
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_RENDER_BEFORE, function(appConfig) {
        throw new Error("I should not fire!");
      }
    );
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_RENDER, function(appConfig) {
        throw new Error("I should not fire!");
      }
    );
    F2.AppHandlers.on(
  ...
  it('should fire in order', function() {
    ...
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_CREATE_ROOT, function(appConfig) {
        appConfig.root = document.body;
    ...
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_DESTROY_BEFORE, function(appConfig) {
        order.push(F2.Constants.AppHandlers.APP_DESTROY_BEFORE);
      }
    );
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_DESTROY, function(appConfig) {
        order.push(F2.Constants.AppHandlers.APP_DESTROY);
      }
    );
    F2.AppHandlers.on(
      containerToken,
      F2.Constants.AppHandlers.APP_DESTROY_AFTER, function(appConfig) {
  ...
  describe('on', function() {
    ...
    it('should allow a handler name to have a trailing namespace', function() {
      expect(function() {
        F2.AppHandlers.on(
          containerToken,
          F2.Constants.AppHandlers.APP_RENDER_BEFORE + '.testing', function(appConfig) {}
        );
      }).not.toThrow();
    });
  ...
  describe('off', function() {
    ...
    it('should remove all type handlers if no namespace is specified', function() {
      ...
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_DESTROY_BEFORE, function() {
          handler1Called = true;
        }
      );
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_DESTROY_BEFORE + ".specialNamespace", function() {
          handler2Called = true;
        }
      );
      F2.AppHandlers.on(
  ...
  describe('APP_RENDER', function() {
    ...
    it('throws if callback is specified, but appConfig.root is not set', function() {
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_RENDER, function() {}
      );
  ...
  describe('APP_DESTROY', function() {
    ...
    it('should prevent app\'s "destroy" method from being called automatically', function() {
      ...
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_DESTROY, function() {}
      );
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_DESTROY_AFTER, function() {
          destroyHandlerCalled = true;
        }
      );
  ...
  describe('APP_SCRIPT_LOAD_FAILED', function() {
    ...
    it('should fire with invalid script path', function() {
      ...
      F2.AppHandlers.on(
        containerToken,
        F2.Constants.AppHandlers.APP_SCRIPT_LOAD_FAILED, function(appConfig, scriptInfo) {
