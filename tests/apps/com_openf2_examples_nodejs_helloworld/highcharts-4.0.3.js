...
(function () {
	...
	L = {
		colors:
			'#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1'.split(
				','
			),
		...
		global: {
			useUTC: !0,
			canvasToolsURL:
				'http://code.highcharts.com/4.0.3/modules/canvas-tools.js',
			VMLRadialGradientURL:
				'http://code.highcharts.com/4.0.3/gfx/vml-radial-gradient.png'
		},
		chart: {
			borderColor: '#4572A7',
			borderRadius: 0,
	...
	G.prototype = {
		opacity: 1,
		textProps:
			'fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke'.split(
				','
			),
		init: function (a, b) {
		...
		clip: function (a) {
			return this.attr(
				'clip-path',
				a ? 'url(' + this.renderer.url + '#' + a.id + ')' : P
			);
		},
		crisp: function (a) {
			var b,
		...
		css: function (a) {
			...
			if (e) {
				e = this.textWidth =
					a && a.width && d.nodeName.toLowerCase() === 'text' && z(a.width);
				b && (a = r(b, c));
				this.styles = a;
	...
	G.prototype.translateXSetter =
		G.prototype.translateYSetter =
		G.prototype.rotationSetter =
		G.prototype.verticalAlignSetter =
		G.prototype.scaleXSetter =
		G.prototype.scaleYSetter =
			function (a, b) {
				this[b] = a;
				this.doTransform = !0;
			};
	G.prototype['stroke-widthSetter'] = G.prototype.strokeSetter = function (
		a,
		b,
		c
	) {
	...
	ta.prototype = {
		...
		init: function (a, b, c, d, e) {
			...
			this.alignedObjects = [];
			this.url =
				(Ta || sb) && x.getElementsByTagName('base').length
					? f.href
							.replace(/#.*?$/, '')
							.replace(/([\('\)])/g, '\\$1')
							.replace(/ /g, '%20')
			...
			this.createElement('desc')
				.add()
				.element.appendChild(x.createTextNode('Created with Highcharts 4.0.3'));
				  ...
				  q(e, function (e, f) {
						...
						q(g, function (e) {
							if (e !== '' || g.length === 1) {
								...
								i.test(e) &&
									!d &&
									(F(o, 'onclick', 'location.href="' + e.match(i)[1] + '"'),
									A(o, { cursor: 'pointer' }));
								e = (e.replace(/<(.|\n)*?>/g, '') || ' ')
									.replace(/&lt;/g, '<')
									.replace(/&gt;/g, '>');
								if (e !== ' ') {
									...
									!m &&
										f &&
										(!ba && d && A(o, { display: 'block' }), F(o, 'dy', Y(o)));
									if (l)
										for (
											var e = e.replace(/([^\^])-/g, '$1- ').split(' '),
												n =
													g.length > 1 ||
													(e.length > 1 && k.whiteSpace !== 'nowrap'),
												q,
												E,
												s = k.HcHeight,
												u = [],
											...
											delete a.bBox,
												...
												!ba &&
													c.forExport &&
													(E = c.measureSpanWidth(o.firstChild.data, a.styles)),
												(q = E > l),
												!q || e.length === 1
													? ((e = u),
													  (u = []),
													  e.length &&
															...
															s && Kb * t > s
																...
																: ((o = x.createElementNS(xa, 'tspan')),
																  ...
																  b.appendChild(o))),
													  E > l && (l = E))
													: (o.removeChild(o.firstChild), u.unshift(e.pop())),
												e.length &&
													o.appendChild(
														x.createTextNode(e.join(' ').replace(/- /g, '-'))
													);
									m++;
								}
							}
		...
		rect: function (a, b, c, d, e, f) {
			var e = da(a) ? a.r : e,
				...
				a = da(a)
					...
					: a === t
					? {}
					: { x: a, y: b, width: u(c, 0), height: u(d, 0) };
		...
		setSize: function (a, b, c) {
			...
			this.height = b;
			for (
				this.boxWrapper[p(c, !0) ? 'animate' : 'attr']({ width: a, height: b });
				e--;
			...
			if (h)
				...
				(k = function (a, b) {
					a.element &&
						...
						a.alignByTranslate ||
							a.translate(v((d - b[0]) / 2), v((e - b[1]) / 2)));
				}),
					(j = a.match(i)[1]),
					(a = Ib[j]),
		...
		label: function (a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				a = o.element.style;
				E =
					(u === void 0 || wb === void 0 || n.styles.textAlign) &&
					o.textStr &&
					o.getBBox();
				...
				if (z) {
					if (!p)
						(a = v(-I * D)),
							...
							(n.box = p =
								d
									? m.symbol(d, a, b, n.width, n.height, y)
									: m.rect(a, b, n.width, n.height, 0, y[Pb])),
							p.attr('fill', P).add(n);
			...
			function k() {
				var a = n.styles,
					...
					c;
				c = h ? 0 : R;
				if (s(u) && E && (a === 'center' || a === 'right'))
					b += { center: 0.5, right: 1 }[a] * (u - E.width);
				if (b !== o.x || c !== o.y) o.attr('x', b), c !== t && o.attr('y', c);
				o.x = b;
				o.y = c;
			}
			function l(a, b) {
	...
	r(G.prototype, {
				...
				if (b.tagName === 'SPAN') {
					...
					if (m !== this.cTT) {
						...
						if (i > l && /[ \-]/.test(b.textContent || b.innerText))
							A(b, { width: l + 'px', display: 'block', whiteSpace: 'normal' }),
								(i = l);
		...
		setSpanRotation: function (a, b, c) {
			...
			d[e + (Ta ? 'Origin' : '-origin')] = d.transformOrigin =
				b * 100 + '% ' + c + 'px';
			A(this.element, d);
		},
	...
	if (!ba && !ga) {
		Z = {
			...
			dashstyleSetter: function (a, b, c) {
				(c.getElementsByTagName('stroke')[0] ||
					$(this.renderer.prepVML(['<stroke/>']), null, null, c))[b] =
					a || 'solid';
				this[b] = a;
			},
			dSetter: function (a, b, c) {
		...
		Z.prototype.ySetter =
			Z.prototype.widthSetter =
			Z.prototype.heightSetter =
				Z.prototype.xSetter;
		var ha = {
			Element: Z,
						...
						if (i === 'gradient')
							...
							var j = m.r,
								...
								j = function () {
									R &&
										((w = d.getBBox()),
										(x += (R[0] - w.x) / w.width - 0.5),
										(y += (R[1] - w.y) / w.height - 0.5),
										(r *= R[2] / w.width),
										(v *= R[2] / w.height));
									D =
										'src="' +
	...
	Sa.prototype = {
		addLabel: function () {
			...
			a.isDatetimeAxis &&
				n &&
				(m = b.dateTimeLabelFormats[n.higherRanks[g] || n.unitName]);
			this.isFirst = k;
			this.isLast = l;
			...
			this.yOffset = e
				? p(
						h.y,
						a.tickBaseline + (a.side === 2 ? 8 : -(e.getBBox().height / 2))
				  )
				: 0;
		},
			...
			if (m && I)
				u === 'inside' && (I = -I),
					...
					n
						...
						: (this.mark = f
								.path(h)
								.attr({ stroke: D, 'stroke-width': m, opacity: c })
								.add(d.axisGroup));
			if (i && !isNaN(x))
				(i.xy = w = this.getLabelPosition(x, w, i, g, k, v, a, s)),
					...
					(this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
						...
						: !d.isRadial &&
						  ...
						  !b &&
						  c !== 0 &&
						  (r = this.handleOverflow(a, w)),
					s && a % s && (r = !1),
					r && !isNaN(w.y)
						? ((w.opacity = c),
						  i[this.isNew ? 'attr' : 'animate'](w),
						  (this.isNew = !1))
						: i.attr('y', -9999);
		},
		destroy: function () {
	...
	S.PlotLineOrBand.prototype = {
		render: function () {
			...
			if (h) {
				if (
					((o = b.getPlotLinePath(l, h)),
					(r = { stroke: q, 'stroke-width': h }),
					m)
				)
					r.dashstyle = m;
			} else if (k) {
	...
	ma.prototype = {
		...
		init: function (a, b) {
			...
			if (this.isLog) (this.val2lin = za), (this.lin2val = ja);
		},
				...
				if (c.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					if (a.isXAxis) {
						if (((d = c.xData), d.length))
							(a.dataMin = C(p(a.dataMin, d[0]), Na(d))),
		...
		setTickPositions: function (a) {
			...
			j
				? ((b.linkedParent = c[b.coll][d.linkedTo]),
				  ...
				  d.type !== b.linkedParent.options.type && oa(11, 1))
				: ((b.min = p(b.userMin, d.min, b.dataMin)),
				  (b.max = p(b.userMax, d.max, b.dataMax)));
			if (g)
				!a && C(b.min, p(b.dataMin, b.min)) <= 0 && oa(10, 1),
					(b.min = ea(za(b.min))),
					(b.max = ea(za(b.max)));
			if (b.range && s(b.max))
				(b.userMin = b.min = u(b.min, b.max - b.range)),
					(b.userMax = b.max),
					(b.range = null);
			...
			b.min === b.max || b.min === void 0 || b.max === void 0
				? (b.tickInterval = 1)
				: j && !n && Y === b.linkedParent.options.tickPixelInterval
				? (b.tickInterval = b.linkedParent.tickInterval)
				: ((b.tickInterval = p(n, I ? 1 : ((b.max - b.min) * Y) / u(b.len, Y))),
				  !s(n) &&
						b.len < Y &&
						!this.isRadial &&
						!this.isLog &&
			...
			if (!h && !g && !n)
				b.tickInterval = mb(b.tickInterval, null, lb(b.tickInterval), d);
			b.minorTickInterval =
			...
			b.tickPositions = a = d.tickPositions
				...
				: k && k.apply(b, [b.min, b.max]);
			if (!a)
				!b.ordinalPositions &&
					(b.max - b.min) / b.tickInterval > u(2 * b.len, 200) &&
					oa(19, !0),
					(a = h
						? b.getTimeTicks(
			...
			if (!j)
				(d = a[0]),
					...
					a.length === 1 &&
						((e = Q(b.max) > 1e13 ? 1 : 0.001), (b.min -= e), (b.max += e));
		},
		...
		zoom: function (a, b) {
			...
			this.allowZoomOutside ||
				(s(c) && a <= C(c, p(e.min, c)) && (a = t),
				s(d) && b >= u(d, p(e.max, d)) && (b = t));
				...
				if (!a.axisTitle)
					(a.axisTitle = c
						...
						.attr({
							...
							align:
								o.textAlign ||
								{ low: 'left', middle: 'center', high: 'right' }[o.align]
						})
			...
			if (r || h)
				if (
					...
					i.length &&
						...
						E &&
							a.min === 0 &&
							(l[-1] || (l[-1] = new Sa(a, -1, null, !0)), l[-1].render(-1))),
					p &&
						q(i, function (b, c) {
							if (c % 2 === 0 && b < a.max)
								n[b] || (n[b] = new S.PlotLineOrBand(a)),
									(v = b + E),
			...
			if (I)
				(b = a.getLinePath(I)),
					a.axisLine
						...
						: (a.axisLine = e
								.path(b)
								.attr({ stroke: f.lineColor, 'stroke-width': I, zIndex: 7 })
								.add(a.axisGroup)),
			...
			if (this.crosshair)
				if ((s(b) || !p(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
					...
					p(d.snap, !0)
						? s(b) &&
						  (c =
								this.chart.inverted != this.horiz
									? b.plotX
									: this.len - b.plotY)
						: (c = this.horiz
								? a.chartX - this.pos
					...
					c = this.isRadial
						? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y))
	...
	Mb.prototype = {
		...
		refresh: function (a, b) {
			...
			i === !1
				? this.hide()
				: (this.isHidden && (ab(d), d.attr('opacity', 1).show()),
				  d.attr({ text: i }),
	...
	Va.prototype = {
		...
		normalize: function (a, b) {
			...
			d.pageX === t
				? ((c = u(a.x, a.clientX - b.left)), (d = a.y))
		...
		runPointActions: function (a) {
			...
			if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
				...
				for (j = 0; j < i; j++)
					if (
						...
						(e._dist = Q(l - e.clientX)), (k = C(k, e._dist)), f.push(e);
			...
			if (h && h.tracker && !c) {
				...
				d &&
					...
					!d.isHidden &&
					((h = d.getAnchor([{}], a)),
					d.updatePosition({ plotX: h[0], plotY: h[1] }));
		...
		reset: function (a) {
			...
			if (a) e.refresh(f), d && d.setState(d.state, !0);
				...
				if (this._onDocumentMouseMove)
					X(x, 'mousemove', this._onDocumentMouseMove),
		...
		drag: function (a) {
			...
			if (this.hasDragged > 10) {
				...
				this.selectionMarker &&
					f &&
					((d -= m),
					this.selectionMarker.attr({ width: Q(d), x: (d > 0 ? 0 : d) + m }));
				this.selectionMarker &&
					g &&
					((d = e - n),
					this.selectionMarker.attr({ height: Q(d), y: (d > 0 ? 0 : d) + n }));
		...
		drop: function (a) {
				...
				if (this.hasDragged || c)
					q(b.axes, function (b) {
						if (b.zoomEnabled) {
							...
							!isNaN(n) &&
								!isNaN(c) &&
								(d[b.coll].push({ axis: b, min: C(n, c), max: u(n, c) }),
								(j = !0));
						}
					}),
						j &&
							K(b, 'selection', d, function (a) {
			...
			if (b)
				A(b.container, { cursor: b._cursor }),
		...
		destroy: function () {
			...
			$a ||
				(X(x, 'mouseup', this.onDocumentMouseUp),
				X(x, 'touchend', this.onDocumentTouchEnd));
	...
	r(S.Pointer.prototype, {
		...
		pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
			...
			b < D.min
				? ((b = D.min), (x = !0))
				: b + o > D.max && ((b = D.max - o), (x = !0));
			x
				? ((v -= 0.8 * (v - g[j][0])), u || (w -= 0.8 * (w - g[j][1])), c())
				: (g[j] = [v, w]);
			r || ((f[j] = p - n), (f[m] = o));
			f = r ? 1 / q : q;
			e[m] = o;
	...
	if (H.PointerEvent || H.MSPointerEvent) {
		...
		r(Va.prototype, {
			...
			batchMSEvents: function (a) {
				a(
					...
					yb ? 'pointerdown' : 'MSPointerDown',
					this.onContainerPointerDown
				);
				a(
					this.chart.container,
					yb ? 'pointermove' : 'MSPointerMove',
		...
		Ma(Va.prototype, 'init', function (a, b, c) {
			...
			(this.hasZoom || this.followTouchMove) &&
				A(b.container, { '-ms-touch-action': P, 'touch-action': P });
		});
	...
	kb.prototype = {
		...
		renderItem: function (a) {
			...
			if (!r) {
				...
				a.legendItem = r = c
					...
					.add(a.legendGroup);
				if (!this.baseline)
					(this.baseline = c.fontMetrics(h.fontSize, r).f + 3 + o),
			...
			c = r.getBBox();
			f = a.checkboxOffset =
				d.itemWidth || a.legendItemWidth || f + g + c.width + k + (D ? 20 : 0);
			this.itemHeight = g = v(a.legendItemHeight || c.height);
			if (e && this.itemX - q + f > (m || b.chartWidth - 2 * j - q - d.x))
				(this.itemX = q),
			...
			e
				? (this.itemX += f)
				: ((this.itemY += o + g + n), (this.lastLineHeight = g));
			this.offsetWidth =
		...
		render: function () {
			...
			if (l || m) {
				...
				if (i) {
					if (g > 0 && h > 0)
						i[i.isNew ? 'attr' : 'animate'](i.crisp({ width: g, height: h })),
							(i.isNew = !1);
				} else
					(a.box = i =
						c
		...
		drawLineMarker: function (a) {
			...
			var e = this.chart.renderer,
				...
				a =
					a.baseline -
					v(
						e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3
					),
				g;
			if (b.lineWidth) {
			...
			if (c && c.enabled !== !1)
				(b = c.radius),
					(this.legendSymbol = d =
						e.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b).add(f)),
					(d.isMarker = !0);
		}
	};
	(/Trident\/7\.0/.test(wa) || Ta) &&
		Ma(kb.prototype, 'positionItem', function (a, b) {
			var c = this,
				d = function () {
	...
	Xa.prototype = {
		...
		redraw: function (a) {
			...
			if (h)
				for (l = k; l--; ) if (((a = c[l]), a.options.stacking)) a.isDirty = !0;
			q(c, function (a) {
		...
		cloneRenderTo: function (a) {
			...
			a
				...
				: (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
				  ...
				  A(b, { position: 'absolute', top: '-9999px', display: 'block' }),
				  b.style.setProperty &&
		...
		setSize: function (a, b, c) {
			...
			if (s(b)) d.chartHeight = f = u(0, v(b));
			...
			if (k)
				f
					...
					: (this.plotBackground = b
							...
							.shadow(a.plotShadow));
			if (l)
				h ? h.animate(u) : (this.plotBGImage = b.image(l, o, p, q, r).add());
			s
				? s.animate({ width: v.width, height: v.height })
				: (this.clipRect = b.clipRect(v));
			if (m)
				g
					? g.animate(g.crisp({ x: o, y: p, width: q, height: r }))
					: (this.plotBorder = b
							.rect(o, p, q, r, 0, -m)
							.attr({
		...
		destroy: function () {
			...
			if (d) (d.innerHTML = ''), X(d), f && Pa(d);
			for (e in a) delete a[e];
		},
		isReadyToRender: function () {
			var a = this;
			return (!ba && H == H.top && x.readyState !== 'complete') ||
				(ga && !H.canvg)
				? (ga
						? Lb.push(function () {
								a.firstRender();
	...
	O.prototype = {
		...
		getCyclic: function (a, b, c) {
			...
			b ||
				(s(d[e])
					? (b = d[e])
					: ((d[e] = b = this.chart[f] % c.length), (this.chart[f] += 1)),
				(b = c[b]));
			this[a] = b;
		},
		getColor: function () {
			this.options.colorByPoint ||
				this.getCyclic(
					'color',
					this.options.color || ca[this.type].color,
			...
			if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)
				...
				if (o && h > o) {
					...
					if (ia(k)) {
						...
						if (s)
							for (c = 0; c < h; c++)
								(i = a[c]), (r[c] = i[0]), (u[c] = i.slice(1, s + 1));
						else
		...
		generatePoints: function () {
			...
			for (m = 0; m < g; m++)
				(i = h + m),
					j
						? (l[m] = new f().init(this, [d[m]].concat(ra(e[m]))))
						: (b[i]
								? (k = b[i])
								: a[i] !== t && (b[i] = k = new f().init(this, a[i], d[m])),
						  (l[m] = k));
			if (b && (g !== (c = b.length) || j))
				for (m = 0; m < c; m++)
					if ((m === h && !j && (m += g), b[m]))
		...
		translate: function () {
			...
			for (
				...
				var l = f[a],
					...
					o = l.low,
					q =
						b && e.stacks[(this.negStacks && n < k ? '-' : '') + this.stackKey];
		...
		drawPoints: function () {
			...
			var l = this.pointAttr[''],
				...
				o = p(
					d.enabled,
					this.activePointCount < (0.5 * this.xAxis.len) / d.radius
				);
			if (d.enabled !== !1 || this._hasPointMarkers)
				for (f = b.length; f--; )
					if (
						...
						(k = g.graphic),
						(i = g.marker || {}),
						(a = (o && i.enabled === t) || i.enabled),
						(m = c.isInsidePlot(v(d), e, c.inverted)),
		...
		getAttribs: function () {
			...
			if (!i || g < i || k)
				for (; g--; ) {
					i = h[g];
					if (
						(c = (i.options && i.options.marker) || i.options) &&
						c.enabled === !1
					)
						c.radius = 0;
		...
		drawGraph: function () {
			...
			q(c, function (c, h) {
				var k = c[0],
					l = a[k];
				if (l) ab(l), l.animate({ d: g });
				else if (d && g.length)
					(l = { stroke: c[1], 'stroke-width': d, fill: P, zIndex: 1 }),
						e
							? (l.dashstyle = e)
							: f && (l['stroke-linecap'] = l['stroke-linejoin'] = 'round'),
	...
	O.prototype.setStackedPoints = function () {
		if (
			...
			for (q = 0; q < d; q++) {
				...
				if (!l[o][r])
					m[o] && m[o][r]
						? ((l[o][r] = m[o][r]), (l[o][r].total = null))
						: (l[o][r] = new Fb(k, k.options.stackLabels, n, r, g));
				o = l[o][r];
				o.points[p] = [o.cum || 0];
				e === 'percent'
					? ((n = n ? h : i),
					  j && l[n] && l[n][r]
							? ((n = l[n][r]),
							  (o.total = n.total = u(n.total, o.total) + Q(s) || 0))
							: (o.total = ea(o.total + (Q(s) || 0))))
					: (o.total = ea(o.total + (s || 0)));
				o.cum = (o.cum || 0) + (s || 0);
	...
	r(Xa.prototype, {
		addSeries: function (a, b, c) {
			...
			a &&
				((b = p(b, !0)),
				K(e, 'addSeries', { options: a }, function () {
					d = e.initSeries(a);
					e.isDirtyLegend = !0;
					e.linkSeries();
					b && e.redraw(c);
	...
	r(O.prototype, {
		addPoint: function (a, b, c, d) {
			...
			Qa(d, i);
			c &&
				q([g, h, this.graphNeg, this.areaNeg], function (a) {
					if (a) a.shift = k + 1;
				});
			if (h) h.isArea = !0;
			b = p(b, !0);
				...
				f
					...
					: (a[e] = a.chart.renderer
							...
							.attr({
								fill: p(
									d[2],
									ya(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()
								),
								zIndex: 0
							})
							.add(a.group));
	...
	ha = la(O, {
		...
		translate: function () {
			var a = this,
				...
				d = (a.borderWidth = p(
					c.borderWidth,
					a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1
				)),
				e = a.yAxis,
			...
			q(a.points, function (c) {
				...
				Q(t) < g &&
					...
					(s = v(
						Q(s - f) > g
							? d - g
							: f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)
					)));
				c.barX = q;
				c.pointWidth = i;
				c.tooltipPos = b.inverted
					? [e.len - h, a.xAxis.len - q - r / 2]
					: [q + r / 2, h];
				r = v(q + r) + l;
				q = v(q) + l;
				r -= q;
			...
			q(a.points, function (h) {
				...
				if (i !== t && !isNaN(i) && h.y !== null)
					(f = h.shapeArgs),
						...
						j
							? (ab(j), j.attr(i)[b.pointCount < e ? 'animate' : 'attr'](w(f)))
		...
		animate: function (a) {
			...
			if (ba)
				a
					? ((e.scaleY = 0.001),
					  (a = C(b.pos + b.len, u(b.pos, b.toPixels(c.threshold)))),
			...
			a.dlProcessOptions && a.dlProcessOptions(d),
				...
				q(e, function (b) {
					...
					if (l && !e) b.dataLabel = l.destroy();
						...
						if (l)
							if (s(h)) l.attr({ text: h }), (q = !1);
							else {
								if (((b.dataLabel = l = l.destroy()), o))
	...
	if (J.pie)
		(J.pie.prototype.drawDataLabels = function () {
			...
			if (a.visible && (e.enabled || a._hasPointLabels)) {
					...
					if (L) {
						...
						for (y = b = 0; !b && F[y]; )
							(b =
								F[y] &&
								F[y].dataLabel &&
								(F[y].dataLabel.getBBox().height || 21)),
								y++;
						if (m > 0) {
							...
							for (y = 0; y < L; y++) {
								...
								var S, P;
								for (P = 0; P < w; P++)
									(S = Q(H[P] - x[1])), S < c && ((c = S), (G = P));
								if (G < y && H[y] !== null) G = y;
								else
									for (
										w < L - y + G && H[y] !== null && (G = w - L + y);
										H[G] === null;
						...
						for (y = 0; y < L; y++) {
							...
							if (m > 0) {
								if (
									...
									(G = w.i),
									(A = w.y),
									(c > A && H[G + 1] !== null) || (c < A && H[G - 1] !== null))
								)
									A = C(u(0, c), d.plotHeight);
							} else A = c;
							B = e.justify
								? n[0] + (J ? -1 : 1) * (o + m)
								: a.getX(A === r - o - m || A === r + o + m ? c : A, J);
							t._attr = { visibility: K, align: x[6] };
							t._pos = {
								x: B + e.x + ({ left: f, right: -f }[x[6]] || 0),
								y: A + e.y - 10
							};
							t.connX = B;
							t.connY = A;
				...
				if (Ba(R) === 0 || this.verifyDataLabelOverflow(R))
							...
							q(this.points, function (b) {
								...
								if ((t = b.dataLabel) && t._pos)
									(K = t._attr.visibility),
										...
										j
											? (j.animate({ d: k }), j.attr('visibility', K))
											: (b.connector = j =
													a.chart.renderer
														.path(k)
														.attr({
			...
			(J.pie.prototype.verifyDataLabelOverflow = function (a) {
				...
				d[0] !== null
					? (e = u(b[2] - u(a[1], a[3]), c))
					: ((e = u(b[2] - a[1] - a[3], c)), (b[0] += (a[3] - a[1]) / 2));
				d[1] !== null
					? (e = u(C(e, b[2] - u(a[0], a[2])), c))
					: ((e = u(C(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
				e < b[2]
					? ((b[2] = e),
					  this.translate(b),
					  q(this.points, function (a) {
		...
		drawTrackerGraph: function () {
			...
			j
				...
				: ((a.tracker = h
						...
						.add(a.group)),
				  q([a.tracker, a.markerGroup], function (a) {
		...
		select: function (a, b) {
			...
			c.firePointEvent(
				...
				function () {
					...
					c.setState(a && 'select');
					b ||
						q(e.getSelectedPoints(), function (a) {
							if (a.selected && a !== c)
			...
			if (
				...
				if (this.graphic)
					(g = g && this.graphic.symbolName && o.r),
						this.graphic.attr(
							w(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})
						),
						k && k.hide();
				else {
					if (a && i)
	...
	r(O.prototype, {
		...
		setState: function (a) {
			...
			if (this.state !== a)
				(this.state = a),
					(e[a] && e[a].enabled === !1) ||
						(a && (b = e[a].lineWidth || b + (e[a].lineWidthPlus || 0)),
						c &&
							!c.dashstyle &&
		...
		setVisible: function (a, b) {
			var c = this,
				...
				h = c.visible;
			f = (c.visible = a = c.userOptions.visible = a === t ? !h : a)
				? 'show'
				: 'hide';
